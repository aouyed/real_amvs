...
def space_time_collocator(days, deltat):
    ...
    for day in days:
        ...
        for time in ('am','pm'):
            ...
            ds = xr.open_dataset('../data/processed/nn_tlv1_' + dsdate+'_'+time+'.nc')
...
def main():
    ...
    df.to_pickle('../data/interim/dataframes/'+month_string+'_nn_tlv1_igra_id.pkl')
    df=pd.read_pickle('../data/interim/dataframes/'+month_string+'_nn_tlv1_igra_id.pkl')
    print(df)
