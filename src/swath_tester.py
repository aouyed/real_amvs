...
def prepare_patch(ds_snpp, ds_j1, start, end):
    ...
    #ds_j1_unit=ds_j1[['specific_humidity_mean','obs_time']]
    #ds_snpp_unit=ds_snpp[['specific_humidity_mean','obs_time']]
...
def ds_unit_calc(ds, day,pressure, time):
    ...
    print('obs time:')
    print(ds['obs_time'].max(skipna=True))
    df=ds.to_dataframe()
